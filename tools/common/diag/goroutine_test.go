...
import (
	...
	"github.com/hyperledger/fabric-x/tools/common/diag"
)
...
func TestCaptureGoRoutines(t *testing.T) {
	...
	gt.Expect(output).To(ContainSubstring("github.com/hyperledger/fabric-x/tools/common/diag.CaptureGoRoutines"))
}
