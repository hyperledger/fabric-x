...
For a deeper dive into ACLS, refer to the topic in the Operations Guide on [ACLs](../access_control.md).
...
Further granularity and control can be achieved if you include [NodeOUs](../msp.md#organizational-units) in your
...
For more information on overriding policy definitions when creating a channel, check out Channel policies and Creating a channel.
