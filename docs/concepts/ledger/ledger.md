...
and [channels](../network/network.md) in the documentation.
...
you've run the basic asset transfer sample application, then you've
created this ledger.
...
In Hyperledger Fabric, each [channel](../network/network.md) has a completely
